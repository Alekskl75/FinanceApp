...
- Механизм взаимодействия микросервисов не задан. Поэтому микросервисы не разделял на отдельные приложения. Можно было взаимодействовать через API или через MessageBroker.
- Часть кода сгенерировал с помощью ИИ.
- В БД решил не делать связующую таблицу "многие-ко-многим".
